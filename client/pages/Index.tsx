              ...
              {activeSection === "primitives" && (
                <div className="space-y-6">
                  <div>
                    ...
                    >
                      Tier 1: Raw hex color values organized by hue and
                      lightness. These are the foundation of our color system.
                    </p>
                  </div>
                  <PrimitivesSection />
                </div>
              ...
              {activeSection === "tokens" && (
                <div className="space-y-6">
                  <div>
                    ...
                    >
                      Tier 2: Semantic mappings that reference primitive colors.
                      These provide meaning and purpose to colors.
                    </p>
                  </div>
                  <TokensSection />
                </div>
              ...
              {activeSection === "variables" && (
                <div className="space-y-6">
                  <div>
                    ...
                    >
                      Tier 3: Contextual usage mapped to semantic tokens. These
                      define how colors are used in specific UI contexts.
                    </p>
                  </div>
                  <VariablesSection />
                </div>
              ...
              {activeSection === "export" && (
                <div className="space-y-6">
                  <div>
                    ...
                    >
                      Download the color system in various formats for use in
                      your projects.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      <li>
                        • Fusion schema includes empty spacing and typography
                        arrays as required
                      </li>
                      <li>
                        • Mantine theme is configured for both light and dark
                        mode support
                      </li>
                      <li>
                        • All colors follow the 3-tier structure: Primitives →
                        Tokens → Variables
                      </li>
                      <li>
                        • Variables tier includes contextual mappings for light
                        and dark modes
                      </li>
                    </ul>
                  </div>
