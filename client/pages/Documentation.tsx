                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-gray-600">
                      A comprehensive 3-tier color token structure designed for
                      scalability and consistency across design systems.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Raw hex color values organized by hue and lightness.
                      </p>
                    ...
                    <div className="p-6 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Semantic mappings that reference primitive colors.
                      </p>
                      <div className="text-xs font-mono text-gray-500">
                    ...
                    <div className="p-6 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Contextual usage mapped to semantic tokens.
                      </p>
                      <div className="text-xs font-mono text-gray-500">
                        {Object.keys(colorVariables.light).length} variables per
                        mode
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-blue-800">
                      <li>
                        • <strong>Scalable:</strong> Easy to add new colors
                        without breaking existing implementations
                      </li>
                      <li>
                        • <strong>Consistent:</strong> Single source of truth
                        for all color values
                      </li>
                      <li>
                        • <strong>Flexible:</strong> Support for light/dark
                        modes and contextual usage
                      </li>
                      <li>
                        • <strong>Framework Agnostic:</strong> Works with any
              ...
              {activeSection === "architecture" && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-gray-600">
                      Understanding the 3-tier token structure and how each tier
                  ...
                  <div className="space-y-8">
                    <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 mb-4">
                        Raw hex color values that serve as the foundation. These
                        are organized by hue (blue, gray, red, etc.) and
                        lightness (50-950).
                      </p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <pre className="text-sm">
                          <code>{`'color/blue/500': '#3b82f6'
'color/gray/100': '#f5f5f5'
'color/red/600': '#dc2626'`}</code>
                        </pre>
                      </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 mb-4">
                        Semantic mappings that reference primitive colors. These
                        provide meaning and intent to color usage.
                      </p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <pre className="text-sm">
                          <code>{`'primary/500': 'color/blue/500'
'success/600': 'color/emerald/600'
'error/500': 'color/red/500'`}</code>
                        </pre>
                      </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 mb-4">
                        Contextual usage mapped to semantic tokens. These define
                        how colors are used in specific UI contexts and support
                        theming.
                      </p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <pre className="text-sm">
                          <code>{`'text-color/primary': 'neutral/900'    // Light mode
'text-color/primary': 'pure-white'     // Dark mode
'bg-color/surface': 'pure-white'       // Light mode
'bg-color/surface': 'neutral/800'      // Dark mode`}</code>
                        </pre>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                    ...
                    <p className="text-amber-800">
                      <strong>Always use the highest tier possible</strong> -
                      components should use variables, not tokens or primitives
                      directly. This ensures maximum flexibility for theming and
                      future changes.
                    </p>
                  </div>
                </div>
              ...
              {activeSection === "implementation" && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-gray-600">
                      Code examples and integration patterns for different
              ...
              {activeSection === "guidelines" && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-gray-600">
                      Best practices for using the color system effectively in
                      your projects.
                    </p>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="border border-emerald-200 bg-emerald-50 rounded-lg p-6">
                          ...
                          <ul className="space-y-2 text-emerald-800 text-sm">
                            ...
                            <li>
                              • Define new tokens when adding brand colors
                            </li>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="border border-gray-200 rounded-lg p-4">
                          ...
                          <pre className="bg-gray-50 rounded p-3 text-sm">
                            <code>{`// Add to colorPrimitives
'color/brand/500': '#your-hex-value'`}</code>
                          </pre>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-lg p-4">
                          ...
                          <pre className="bg-gray-50 rounded p-3 text-sm">
                            <code>{`// Add to colorTokens
'brand/500': 'color/brand/500'`}</code>
                          </pre>
                        </div>
  ...
  'interactive/brand': 'brand/500'
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                      ...
                      <ul className="space-y-2 text-gray-700 text-sm">
                        <li>
                          • Ensure sufficient contrast ratios (4.5:1 for normal
                        ...
                        <li>
                          • Provide alternative indicators for color-coded
                          information
                        </li>
                        <li>
                          • Consider color blindness when choosing color
                          combinations
                        </li>
                        <li>
                          • Use the{" "}
