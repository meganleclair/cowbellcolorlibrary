...
export const colorVariables = {
  light: {
    ...
    'border-color/information': 'information-300',
  ...
  dark: {
    // Text colors
    'text-color/primary': 'neutral-white',
    ...
    'text-color/information': 'information-400',
    ...
    'bg-color/overlay': 'neutral-black',
    ...
    'bg-color/information': 'information-1000',
    ...
    'border-color/information': 'information-700',
